...
abstract class ThinkOauth{
	...
	public function __construct($token = null){
		...
		//获取应用配置
		Config::load(APP_PATH.'/auth/oauthsdk/sdk_config.php','','sdk'); 
		$config = Config::get("THINK_SDK_{$this->Type}",'sdk');
    ...
    public static function getInstance($type, $token = null) {
    	...
    	$classname = 'app\auth\oauthsdk\sdk\\'.$name;
